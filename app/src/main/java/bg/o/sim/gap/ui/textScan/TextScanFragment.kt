...
import bg.o.sim.gap.databinding.FragmentTextScanBinding
import com.google.android.material.snackbar.Snackbar
import java.util.concurrent.ExecutorService
import java.util.concurrent.Executors

class TextScanFragment : Fragment() {
    private lateinit var viewBinding: FragmentTextScanBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = FragmentTextScanBinding.inflate(inflater, container, false)
        ...
        cameraProviderFuture.addListener(
            {
                ...
                val imageAnalysis = ImageAnalysis.Builder()
                    ...
                    .build()
                    .apply {
                        setAnalyzer(ContextCompat.getMainExecutor(requireContext()), TextImageAnalyzer(viewBinding.overlay))
                    }
